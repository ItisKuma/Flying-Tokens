...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/PlayerApi.js
...
var PlayerApi = class {
	...
	hasPermission(permission) {
		return __awaiter$19(this, void 0, void 0, function* () {
			if ((yield this.getRole()) === "GM") return true;
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/ViewportApi.js
...
var ViewportApi = class {
	...
	animateToBounds(bounds) {
		return __awaiter$18(this, void 0, void 0, function* () {
			yield this.messageBus.sendAsync("OBR_VIEWPORT_ANIMATE_TO_BOUNDS", { bounds });
		});
	}
	getPosition() {
		return __awaiter$18(this, void 0, void 0, function* () {
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/messages/Message.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/messages/MessageBus.js
	...
	constructor(origin, roomId) {
		...
		*/
		this.send = (id, data, nonce) => {
			...
			(_a = window.parent) === null || _a === void 0 || _a.postMessage({
				id,
				data,
				ref: this.ref,
				nonce
		...
		this.sendAsync = (id, data, timeout = 5e3) => {
			...
			}), ...timeout > 0 ? [new Promise((_, reject) => window.setTimeout(() => reject(/* @__PURE__ */ new Error(`Message ${id} took longer than ${timeout}ms to get a result`)), timeout))] : []]);
		};
		this.roomId = roomId;
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/NotificationApi.js
...
var NotificationApi = class {
	...
	show(message, variant) {
		return __awaiter$17(this, void 0, void 0, function* () {
			const { id } = yield this.messageBus.sendAsync("OBR_NOTIFICATION_SHOW", {
				message,
				variant
			});
			return id;
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/scene/SceneFogApi.js
...
var SceneFogApi = class {
	...
	setStrokeWidth(strokeWidth) {
		return __awaiter$16(this, void 0, void 0, function* () {
			yield this.messageBus.sendAsync("OBR_SCENE_FOG_SET_STROKE_WIDTH", { strokeWidth });
		});
	}
	getFilled() {
		return __awaiter$16(this, void 0, void 0, function* () {
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/scene/SceneGridApi.js
...
var SceneGridApi = class {
	...
	setLineType(lineType) {
		return __awaiter$15(this, void 0, void 0, function* () {
			yield this.messageBus.sendAsync("OBR_SCENE_GRID_SET_LINE_TYPE", { lineType });
		});
	}
	getMeasurement() {
		return __awaiter$15(this, void 0, void 0, function* () {
	...
	setMeasurement(measurement) {
		return __awaiter$15(this, void 0, void 0, function* () {
			yield this.messageBus.sendAsync("OBR_SCENE_GRID_SET_MEASUREMENT", { measurement });
		});
	}
	getLineWidth() {
		return __awaiter$15(this, void 0, void 0, function* () {
	...
	setLineWidth(lineWidth) {
		return __awaiter$15(this, void 0, void 0, function* () {
			yield this.messageBus.sendAsync("OBR_SCENE_GRID_SET_LINE_WIDTH", { lineWidth });
		});
	}
	...
	getDistance(from, to) {
		return __awaiter$15(this, void 0, void 0, function* () {
			const { distance } = yield this.messageBus.sendAsync("OBR_SCENE_GRID_GET_DISTANCE", {
				from,
				to
			});
			return distance;
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/scene/SceneHistoryApi.js
...
function enablePatches() {
	...
	function generatePatches_(state, basePath, patches, inversePatches) {
		switch (state.type_) {
			case 0:
			case 2: return generatePatchesFromAssigned(state, basePath, patches, inversePatches);
			case 1: return generateArrayPatches(state, basePath, patches, inversePatches);
			case 3: return generateSetPatches(state, basePath, patches, inversePatches);
		}
	}
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/scene/SceneItemsApi.js
...
var SceneItemsApi = class {
	...
	updateItems(filterOrItems, update) {
		return __awaiter$13(this, void 0, void 0, function* () {
			let items;
			if (this.isItemArray(filterOrItems)) items = filterOrItems;
			else items = yield this.getItems(filterOrItems);
			...
			for (const patch of patches) {
				...
				if (typeof index === "number" && typeof key === "string") nextUpdates[index][key] = nextState[index][key];
			}
			const updates = nextUpdates.filter((update) => Object.keys(update).length > 2);
			if (updates.length === 0) return;
			yield this.messageBus.sendAsync("OBR_SCENE_ITEMS_UPDATE_ITEMS", { updates });
		});
	}
	addItems(items) {
		return __awaiter$13(this, void 0, void 0, function* () {
			yield this.messageBus.sendAsync("OBR_SCENE_ITEMS_ADD_ITEMS", { items });
		});
	}
	deleteItems(ids) {
		return __awaiter$13(this, void 0, void 0, function* () {
			yield this.messageBus.sendAsync("OBR_SCENE_ITEMS_DELETE_ITEMS", { ids });
		});
	}
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/scene/SceneLocalApi.js
...
var SceneLocalApi = class {
	...
	addItems(items) {
		return __awaiter$12(this, void 0, void 0, function* () {
			yield this.messageBus.sendAsync("OBR_SCENE_LOCAL_ADD_ITEMS", { items });
		});
	}
	deleteItems(ids) {
		return __awaiter$12(this, void 0, void 0, function* () {
			yield this.messageBus.sendAsync("OBR_SCENE_LOCAL_DELETE_ITEMS", { ids });
		});
	}
	getItemAttachments(ids) {
		return __awaiter$12(this, void 0, void 0, function* () {
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/scene/SceneApi.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/common/normalize.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/ContextMenuApi.js
...
var ContextMenuApi = class {
	constructor(messageBus) {
		...
		this.handleClick = (event) => {
			...
			if (menu) (_a = menu.onClick) === null || _a === void 0 || _a.call(menu, event.context, event.elementId);
		};
		this.messageBus = messageBus;
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/ToolApi.js
...
var ToolApi = class {
	constructor(messageBus) {
		...
		this.handleToolClick = (event) => {
			...
			if (tool) if (tool.onClick) {
				const result = tool.onClick(event.context, event.elementId);
				Promise.resolve(result).then((activate) => {
					if (activate) this.messageBus.send("OBR_TOOL_ACTIVATE", { id: event.id });
				});
			} else this.messageBus.send("OBR_TOOL_ACTIVATE", { id: event.id });
		};
		this.handleToolActionClick = (event) => {
			var _a;
			const action = this.toolActions[event.id];
			if (action) (_a = action.onClick) === null || _a === void 0 || _a.call(action, event.context, event.elementId);
		};
		this.handleToolModeClick = (event) => {
			const mode = this.toolModes[event.id];
			if (mode) if (mode.onClick) {
				const result = mode.onClick(event.context, event.elementId);
				Promise.resolve(result).then((activate) => {
					if (activate) this.messageBus.send("OBR_TOOL_MODE_ACTIVATE", {
			...
			if (mode) {
				if (mode.onToolClick) {
					...
					Promise.resolve(result).then((select) => {
						if (select && event.event.target && !event.event.target.locked) this.messageBus.sendAsync("OBR_PLAYER_SELECT", { items: [event.event.target.id] });
					});
				} else if (event.event.target && !event.event.target.locked) this.messageBus.sendAsync("OBR_PLAYER_SELECT", { items: [event.event.target.id] });
			}
		};
		this.handleToolModeToolDoubleClick = (event) => {
			...
			if (mode) {
				if (mode.onToolDoubleClick) {
					...
					Promise.resolve(result).then((select) => {
						if (select && event.event.target) this.messageBus.sendAsync("OBR_PLAYER_SELECT", { items: [event.event.target.id] });
					});
				} else if (event.event.target) this.messageBus.sendAsync("OBR_PLAYER_SELECT", { items: [event.event.target.id] });
			}
		};
		this.handleToolModeToolDown = (event) => {
			var _a;
			const mode = this.toolModes[event.id];
			if (mode) (_a = mode.onToolDown) === null || _a === void 0 || _a.call(mode, event.context, event.event);
		};
		this.handleToolModeToolMove = (event) => {
			var _a;
			const mode = this.toolModes[event.id];
			if (mode) (_a = mode.onToolMove) === null || _a === void 0 || _a.call(mode, event.context, event.event);
		};
		this.handleToolModeToolUp = (event) => {
			var _a;
			const mode = this.toolModes[event.id];
			if (mode) (_a = mode.onToolUp) === null || _a === void 0 || _a.call(mode, event.context, event.event);
		};
		this.handleToolModeToolDragStart = (event) => {
			var _a;
			const mode = this.toolModes[event.id];
			if (mode) (_a = mode.onToolDragStart) === null || _a === void 0 || _a.call(mode, event.context, event.event);
		};
		this.handleToolModeToolDragMove = (event) => {
			var _a;
			const mode = this.toolModes[event.id];
			if (mode) (_a = mode.onToolDragMove) === null || _a === void 0 || _a.call(mode, event.context, event.event);
		};
		this.handleToolModeToolDragEnd = (event) => {
			var _a;
			const mode = this.toolModes[event.id];
			if (mode) (_a = mode.onToolDragEnd) === null || _a === void 0 || _a.call(mode, event.context, event.event);
		};
		this.handleToolModeToolDragCancel = (event) => {
			var _a;
			const mode = this.toolModes[event.id];
			if (mode) (_a = mode.onToolDragCancel) === null || _a === void 0 || _a.call(mode, event.context, event.event);
		};
		this.handleToolModeKeyDown = (event) => {
			var _a;
			const mode = this.toolModes[event.id];
			if (mode) (_a = mode.onKeyDown) === null || _a === void 0 || _a.call(mode, event.context, event.event);
		};
		this.handleToolModeKeyUp = (event) => {
			var _a;
			const mode = this.toolModes[event.id];
			if (mode) (_a = mode.onKeyUp) === null || _a === void 0 || _a.call(mode, event.context, event.event);
		};
		this.handleToolModeActivate = (event) => {
			var _a;
			const mode = this.toolModes[event.id];
			if (mode) (_a = mode.onActivate) === null || _a === void 0 || _a.call(mode, event.context);
		};
		this.handleToolModeDeactivate = (event) => {
			var _a;
			const mode = this.toolModes[event.id];
			if (mode) (_a = mode.onDeactivate) === null || _a === void 0 || _a.call(mode, event.context);
		};
		this.messageBus = messageBus;
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/PopoverApi.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/ModalApi.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/ActionApi.js
...
var ActionApi = class {
	...
	setBadgeBackgroundColor(badgeBackgroundColor) {
		return __awaiter$6(this, void 0, void 0, function* () {
			yield this.messageBus.sendAsync("OBR_ACTION_SET_BADGE_BACKGROUND_COLOR", { badgeBackgroundColor });
		});
	}
	getIcon() {
		return __awaiter$6(this, void 0, void 0, function* () {
	...
	setIcon(icon) {
		return __awaiter$6(this, void 0, void 0, function* () {
			...
			yield this.messageBus.sendAsync("OBR_ACTION_SET_ICON", { icon: data[0].icon });
		});
	}
	getTitle() {
		return __awaiter$6(this, void 0, void 0, function* () {
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/InteractionApi.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/PartyApi.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/RoomApi.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/ThemeApi.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/AssetsApi.js
...
var AssetsApi = class {
	...
	downloadImages(multiple, defaultSearch, typeHint) {
		return __awaiter$1(this, void 0, void 0, function* () {
			const { images } = yield this.messageBus.sendAsync("OBR_ASSETS_DOWNLOAD_IMAGES", {
				multiple,
				defaultSearch,
				typeHint
			}, -1);
	...
	downloadScenes(multiple, defaultSearch) {
		return __awaiter$1(this, void 0, void 0, function* () {
			const { scenes } = yield this.messageBus.sendAsync("OBR_ASSETS_DOWNLOAD_SCENES", {
				multiple,
				defaultSearch
			}, -1);
			return scenes;
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/api/BroadcastApi.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/GenericItemBuilder.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/CurveBuilder.js
var CurveBuilder = class extends GenericItemBuilder {
	...
	build() {
		return Object.assign(Object.assign({}, this._item), {
			type: "CURVE",
			points: this._points,
			style: this._style
		});
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/ImageBuilder.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/LabelBuilder.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/LineBuilder.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/PointerBuilder.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/RulerBuilder.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/ShapeBuilder.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/TextBuilder.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/PathBuilder.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/ImageUploadBuilder.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/SceneUploadBuilder.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/common/getDetails.js
function getDetails() {
	const ref = new URLSearchParams(window.location.search).get("obrref");
	let origin = "";
	let roomId = "";
	if (ref) {
		const parts = decode(ref).split(" ");
		if (parts.length === 2) {
			origin = parts[0];
			roomId = parts[1];
		}
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/BillboardBuilder.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/EffectBuilder.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/LightBuilder.js
var LightBuilder = class extends GenericItemBuilder {
	constructor(player) {
		super(player);
		this._sourceRadius = 50;
		this._attenuationRadius = 1800;
		this._falloff = 1;
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/builders/WallBuilder.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/types/items/Billboard.js
function isBillboard(item) {
	return item.type === "BILLBOARD";
}
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/types/items/Curve.js
function isCurve(item) {
	return item.type === "CURVE";
}
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/types/items/Effect.js
function isEffect(item) {
	return item.type === "EFFECT";
}
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/types/items/Image.js
function isImage(item) {
	return item.type === "IMAGE";
}
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/types/items/Label.js
function isLabel(item) {
	return item.type === "LABEL";
}
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/types/items/Light.js
function isLight(item) {
	return item.type === "LIGHT";
}
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/types/items/Line.js
function isLine(item) {
	return item.type === "LINE";
}
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/types/items/Path.js
var Command;
(function(Command) {
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/types/items/Pointer.js
function isPointer(item) {
	return item.type === "POINTER";
}
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/types/items/Ruler.js
function isRuler(item) {
	return item.type === "RULER";
}
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/types/items/Shape.js
function isShape(item) {
	return item.type === "SHAPE";
}
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/types/items/Text.js
function isText(item) {
	return item.type === "TEXT";
}
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/types/items/TextContent.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/types/items/Wall.js
function isWall(item) {
	return item.type === "WALL";
}
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/common/number.js
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/math/Math2.js
/**
...
var Math2 = class {
	...
	*/
	static pointInPolygon(p, points) {
		...
		let isInside = false;
		for (let i = 0, j = points.length - 1; i < points.length; j = i++) if (points[i].y > p.y !== points[j].y > p.y && p.x < (points[j].x - points[i].x) * (p.y - points[i].y) / (points[j].y - points[i].y) + points[i].x) isInside = !isInside;
		return isInside;
	}
	/**
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/math/MathM.js
/**
...
var MathM = class MathM {
	...
	*/
	static inverse(matrix) {
		...
		if (Math.abs(det) < 1e-14) return matrix;
		const invdet = 1 / det;
		return [
			(m5 * m9 - m8 * m6) * invdet,
			(m3 * m8 - m2 * m9) * invdet,
...
//#endregion
//#region ../node_modules/@owlbear-rodeo/sdk/lib/index.js
var details = getDetails();
var messageBus = new MessageBus(details.origin, details.roomId);
var viewportApi = new ViewportApi(messageBus);
var playerApi = new PlayerApi(messageBus);
var OBR = {
	onReady: (callback) => {
		if (messageBus.ready) callback();
		else messageBus.once("OBR_READY", () => callback());
	},
	get isReady() {
	...
	popover: new PopoverApi(messageBus),
	modal: new ModalApi(messageBus),
	action: new ActionApi(messageBus),
	interaction: new InteractionApi(messageBus),
	room: new RoomApi(messageBus),
	theme: new ThemeApi(messageBus),
	assets: new AssetsApi(messageBus),
	broadcast: new BroadcastApi(messageBus),
...
//#endregion
export { Command, Math2, MathM, buildBillboard, buildCurve, buildEffect, buildImage, buildImageUpload, buildLabel, buildLight, buildLine, buildPath, buildPointer, buildRuler, buildSceneUpload, buildShape, buildText, buildWall, OBR as default, isBillboard, isCurve, isEffect, isElement, isFormattedText, isImage, isLabel, isLight, isLine, isPath, isPointer, isRuler, isShape, isText, isWall };
